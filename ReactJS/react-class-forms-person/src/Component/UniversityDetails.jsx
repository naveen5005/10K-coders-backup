...
export default class UniversityDetails extends Component {
    ...
    deleteUser = (usr)=>{
        var latestUsers = this.state.allusers.filter((myUser,i)=> myUser.university != usr.university);
    ...
    render() {
        return (
            <div>
                <h1><u>Univeristy Registration Details</u></h1> <br />
                <form action="">
                    <label htmlFor="">University</label>
                    <input type="text" name="university" value={this.state.RegistrationDetails.university} onChange={(e) => { this.changeHandle(e) }} /> <br />
                    <label htmlFor="">Insitute</label>
                    <input type="text" name="institute" value={this.state.RegistrationDetails.institute} onChange={(e) => { this.changeHandle(e) }} /> <br />
                    <label htmlFor="">Branch</label>
                    <select name="branch" value={this.state.RegistrationDetails.branch}  onChange={(e) => { this.changeHandle(e) }}>
                    ...
                    <select name="degree" value={this.state.RegistrationDetails.degree}  onChange={(e) => { this.changeHandle(e) }}>
                        <option value={""}>--select one Degree--</option>
                        <option value={"B.Tech"}>B.Tech</option>
                        <option value={"M.Tech"}>M.Tech</option>
                    </select> <br />
                    <input type="radio" name="status" checked={this.state.RegistrationDetails.status == "Pursuing"} value= {"Pursuing"} onChange={(e) => { this.changeHandle(e) }} />
                    <label htmlFor="">Pursuing</label> <br />
                    <input type="radio" name="status" checked={this.state.RegistrationDetails.status == "Completed"} value={"Completed"} onChange={(e) => { this.changeHandle(e) }} />
                    <label htmlFor="">Completed</label> <br />
                    <label htmlFor="">Average CPI</label>
                    <input type="number" name="avgCPI" id="" value={this.state.RegistrationDetails.avgCPI} onChange={(e) => { this.changeHandle(e) }} /><br />
                    <label htmlFor="">th Semester</label>
                    <input type="number" name="thSemester" id="" value={this.state.RegistrationDetails.thSemester} onChange={(e) => { this.changeHandle(e) }} /> <br />
