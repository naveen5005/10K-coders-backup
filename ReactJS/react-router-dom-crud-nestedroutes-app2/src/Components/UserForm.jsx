...
const UserForm = ({user2,handleChange,handleButton,btnName}) => {
    return (
        <div>
            <form>
                <div className="mb-3">
                ...
                <div className="mb-3">
                    <select className="form-control" name="branch" value={user2.branch} onChange={(e) => { handleChange(e) }}>
                ...
                <div className="mb-3">
                    <select className="form-control" name="degree" value={user2.degree} onChange={(e) => { handleChange(e) }}>
                ...
                <div className="mb-3">
                    ...
                    <div className="form-check">
                        <input className="form-check-input" name='areasofInterest' type="checkbox" value="singing" onChange={(e) => { handleChange(e)}} checked={user2.areasofInterest.indexOf("singing") > -1} />
                        <label className="form-check-label" htmlFor="flexCheckDefault">
                            singing
                        </label>
                    </div>
                    <div className="form-check">
                        <input className="form-check-input" name='areasofInterest' type="checkbox" value="coding" onChange={(e) => { handleChange(e)}} checked={user2.areasofInterest.indexOf("coding") > -1} />
                        <label className="form-check-label" htmlFor="flexCheckDefault">
                            coding
                        </label>
                    </div>
                    <div className="form-check">
                        <input className="form-check-input" name='areasofInterest' type="checkbox" value="playing" onChange={(e) => { handleChange(e)}} checked={user2.areasofInterest.indexOf("playing") > -1} />
                        <label className="form-check-label" htmlFor="flexCheckDefault">
                            playing
                        </label>
                    </div>
